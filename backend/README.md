...
スケジュール情報を更新します。`event_id` と更新対象フィールドのみ送信してください。
...
[
  {
    ...
    "location": "東京",
    "notify_at": "2025-05-21T15:00:00+09:00",
    "address": "東京都"
  },
  {
    "event_id": "abc123xyz",
...
| `location`   | string | イベントの開催場所           |
| `notify_at`  | string | イベント通知日時（ISO 形式） |
| `address`    | string | イベントの開催住所           |
